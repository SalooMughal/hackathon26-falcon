...
notificationsRouter.post("/create", validate(createSchema, "body"), verifyToken, checkPermissions, notificationsController.create);
notificationsRouter.post("/sudo/create", validate(sudoCreateSchema, "body"), verifyToken, checkPermissions, notificationsController.sudoCreate);

notificationsRouter.post("/update", validate(updateNoticeSchema, "body"), verifyToken, checkPermissions, notificationsController.updateNotice);
